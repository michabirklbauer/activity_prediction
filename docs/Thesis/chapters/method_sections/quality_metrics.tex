...
The enrichment factor (EF) describes the relation of the truely active compounds among all as active predicted complexes and the relative share of active compounds in the dataset.
