...
For better visualization of the four base metrics, mentioned in \ref*{terminology},
...
space, where their location is defined by the FPR \ref*{terminology} on the x-axis and the TPR($\frac{\#TP}{\#TP+\#FN}$) on the y-axis. 
...
The integral of the ROC curve is calculated using the \href{https://scikit-learn.org/stable/index.html}{scikit-learn}
 package and is always between 0 and 1(higher is better)\cite[]{Lopes2017}.
