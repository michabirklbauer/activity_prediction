...
Using a fixed \textit{learning rate} the \textit{step size} for gradient descent is calculated by multiplying with the result from the derivative loss function. 
