...
\begin{enumerate}
    ...
    \item Training and inference of an ANN comes down to a set of matrix multiplication, which can be efficiently computed dedicated hardware like GPUs and TPUs\cite[]{Jouppi2017}.  
\end{enumerate}
