...
\begin{figure}[H]
    \begin{center}
        ...
        \caption[]{Baseline random forest(\textit{baseline\_rf}) confusion matrix\\
            ...
            Additionally, the number of false-positives is really low, which is an important metric for drug design.}
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption[]{Feature engineering permutation importance \acrshort*[]{knn}(\textit{fe\_rf\_per\_knn}) confusion matrix\\
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption[]{Feature engineering permutation importance \acrshort*[]{knn}(\textit{fe\_rf\_per\_knn}) ROC curve\\
...
Overall, the scoring functions achieved an accuracy of 80.00\% on the test set. Additionally, the random forest models did not classify a single inactive compound as active.
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption[]{Feature engineering permutation importance confusion matrix for \acrshort*[]{knn}(\textit{fe\_rf\_per\_knn})\\
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption[]{Baseline neural network(\textit{baseline\_nn}) confusion matrix\\
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption[]{Feature engineering permutation importance ROC curve for \acrshort*[]{knn}(\textit{fe\_rf\_per\_knn})\\
...
\begin{figure}[H]
    \begin{center}
        ...
        \caption[]{Baseline neural network(\textit{baseline\_nn}) ROC curve\\
